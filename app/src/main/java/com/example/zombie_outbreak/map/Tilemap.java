...
import static com.example.zombie_outbreak.map.MapLayout.NUMBER_OF_COLUMN_TILES;
import static com.example.zombie_outbreak.map.MapLayout.NUMBER_OF_ROW_TILES;
import static com.example.zombie_outbreak.map.MapLayout.TILE_HEIGHT_PIXELS;
import static com.example.zombie_outbreak.map.MapLayout.TILE_WIDTH_PIXELS;
